...
describe("Course Controller", () => {
  ...
  describe("createCourse", () => {
    it("should create a new course", async () => {
      const req = {
        body: { code: "CSE101", name: "Introduction to Computer Science" },
      };
      const res = {
  ...
  // Test cases for getCourses function
  describe("getCourses", () => {
  ...
  // Test cases for updateCourse function
  ...
  // Test cases for deleteCourse function
  ...
  // Test cases for assignFaculty function
  describe("assignFaculty", () => {
    it("should assign a faculty to a course", async () => {
      ...
      courseService.assignFaculty.mockResolvedValue({
        message: "Faculty member is assigned successfully",
      });
      ...
      expect(res.json).toHaveBeenCalledWith(
        "Faculty member is assigned successfully"
      );
    });
  ...
  // Test cases for removeFaculty function
  describe("removeFaculty", () => {
    it("should remove a faculty from a course", async () => {
      ...
      courseService.removeFaculty.mockResolvedValue({
        message: "Faculty member is removed successfully",
      });
      ...
      expect(res.status).toHaveBeenCalledWith(200);
      expect(res.json).toHaveBeenCalledWith(
        "Faculty member is removed successfully"
      );
    });
  ...
  // Test cases for getCourseById function
