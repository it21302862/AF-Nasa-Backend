...
describe("Student Enrollment Controller", () => {
  ...
  // Test cases for enrollStudentInCourse function
  describe("enrollStudentInCourse", () => {
    it("should enroll a student in a course", async () => {
      ...
      studentEnrollmentService.enrollStudentInCourse.mockResolvedValue(
        mockEnrollment
      );
    ...
    it("should handle errors when enrolling a student in a course", async () => {
      ...
      studentEnrollmentService.enrollStudentInCourse.mockRejectedValue(
  ...
  // Test cases for getStudentEnrollments function
  describe("getStudentEnrollments", () => {
    it("should get all enrollments for a student", async () => {
      ...
      studentEnrollmentService.getStudentEnrollment.mockResolvedValue(
        mockEnrollments
      );
    ...
    it("should handle errors when getting enrollments for a student", async () => {
      ...
      studentEnrollmentService.getStudentEnrollment.mockRejectedValue(
        new Error(errorMessage)
      );
  ...
  // Test cases for getAllEnrollmentForCourse function
  describe("getAllEnrollmentForCourse", () => {
    it("should get all enrollments for a course", async () => {
      ...
      const mockEnrollments = [{ _id: "123", studentId: "1", courseId: "101" }];
      studentEnrollmentService.getAllEnrollmentForCourse.mockResolvedValue(
        mockEnrollments
      );
    ...
    it("should handle errors when getting all enrollments for a course", async () => {
      ...
      studentEnrollmentService.getAllEnrollmentForCourse.mockRejectedValue(
        new Error(errorMessage)
      );
  ...
  // Test cases for unenrollStudentFromCourse function
  describe("unenrollStudentFromCourse", () => {
    ...
    it("should handle errors when unenrolling a student from a course", async () => {
      ...
      studentEnrollmentService.unenrollStudentFromCourse.mockRejectedValue(
        new Error(errorMessage)
      );
