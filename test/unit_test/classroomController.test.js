  ...
  describe('Classroom Controller', () => {
    ...
    describe('createClassRoom', () => {
      it('should create a new classroom', async () => {
        const req = { body: { code: 'CR101', location: 'Building A', capacity: 30 } };
        const res = {
          status: jest.fn().mockReturnThis(),
          json: jest.fn(),
        };
  
        const mockCreatedClassRoom = { _id: '123', code: 'CR101', location: 'Building A', capacity: 30 };
        classRoomService.createClassRoom.mockResolvedValue({ message: 'Classroom added successfully', classRoom: mockCreatedClassRoom });
  
        await createClassRoom(req, res);
  
        expect(res.status).toHaveBeenCalledWith(201);
        // expect(res.json).toHaveBeenCalledWith({ classRoom: mockCreatedClassRoom });
      });
      ...
      it('should handle errors when creating a classroom', async () => {
        ...
        classRoomService.createClassRoom.mockRejectedValue(new Error(errorMessage));
    ...
    describe('getClassRooms', () => {
      ...
      describe('getClassRoomById', () => {
        it('should get a classroom by ID', async () => {
          ...
          const mockClassRoom = { _id: classRoomId, code: 'CR101', location: 'Building A', capacity: 30 };
        ...
        it('should handle errors when getting a classroom by ID', async () => {
          ...
          classRoomService.getClassRoomById.mockRejectedValue(new Error(errorMessage));
      ...
      describe('updateClassRoom', () => {
        it('should update a classroom by ID', async () => {
          ...
          classRoomService.updateClassRoom.mockResolvedValue({ message: 'Classroom updated successfully' });
        ...
        it('should handle errors when updating a classroom by ID', async () => {
          ...
          classRoomService.updateClassRoom.mockRejectedValue(new Error(errorMessage));
      ...
      describe('deleteClassRoom', () => {
        it('should delete a classroom by ID', async () => {
          ...
          classRoomService.deleteClassRoom.mockResolvedValue({ message: 'Classroom deleted successfully' });
        ...
        it('should handle errors when deleting a classroom by ID', async () => {
          ...
          classRoomService.deleteClassRoom.mockRejectedValue(new Error(errorMessage));
    ...
    // Other test cases for other controller functions
  });
